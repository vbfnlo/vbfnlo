...
## [3.0.0 beta 3] - 2017-01-16

### Major Enhancements
* VBFNLO is now published also at https://github.com/vbfnlo/vbfnlo
* Processes generated by running `ggflo` now use `vbfnlo` as well
...
* Add dimension-8 operator O_{S,2}_ and adjust K-matrix unitarization accordingly
