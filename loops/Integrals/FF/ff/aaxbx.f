...
*	Calls vbfffxb0, vbfffxb1, vbfffxb2p, vbfffxdb0.				*
*									*
...
*
	ldot = .TRUE.
	ier1 = ier
	call vbfffxb0(cbxi(1),d0,xmu,xp,xma,xmb,ier1)
...
*  #[ level 1/2 : B0':
	if (aderiv) then
	    ier0 = ier
	    call vbfffxdb0(acbxi(1),acb0p,xp,xma,xmb,ier0)
...
*
	ier0 = ier
	call vbfffxa0(caxi(1),d0,xmu,xma,ier0)
	maxi(1) = absc(caxi(1))*DBLE(10)**mod(ier0,50)
	ier1 = max(ier1,ier0)
	ier0 = ier
	call vbfffxa0(caxi(2),d0,xmu,xmb,ier0)
...
*	and get the B11
*
	call vbfffxb1(cbxi(2),cbxi(1),caxi,xp,xma,xmb,fpij2,ier1)
...
*	just a simple call...
*
	call vbfffxb2p(cbxi(3),cbxi(2),cbxi(1),caxi,xp,xma,xmb,fpij2,ier1)
