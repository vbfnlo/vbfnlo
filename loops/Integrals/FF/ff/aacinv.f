...
*
	ier0 = ier
	call vbfffcel2(cdel2,cfpij4,10,6,7,10,1,ier0)
	ier1 = max(ier0,ier1)
	ci4(1) = +cdel2*(1/fdel3)
*
	...
	if ( lwarn .and. absc(cdel2).lt.xloss*absc(cfpij4(5,7)**2) ) 
     +		then
	    ier0 = ier
	    call vbfffwarn(263,ier0,cdel2,absc(cfpij4(5,7)**2))
	    ier1 = max(ier0,ier1)
	endif
	ci4(2) = +cdel2*(1/fdel3)
*
	ier0 = ier
	call vbfffdel2(cdel2,cfpij4,10,5,6,9,1,ier0)
	ier1 = max(ier0,ier1)
	ci4(3) = +cdel2*(1/fdel3)
*
	ier0 = ier
	call vbfffdl2t(cdel2,cfpij4,5,7,6,7,10,-1,-1,10,ier0)
	ier1 = max(ier1,ier0)
	ci4(4) = -cdel2*(1/fdel3)
*
	ier0 = ier
	call vbfffdl2i(cdel2,cfpij4,10,5,6,9,-1,6,7,10,+1,ier0)
	ier1 = max(ier1,ier0)
	ci4(5) = +cdel2*(1/fdel3)
*
	ier0 = ier
	call vbfffdl2t(cdel2,cfpij4,5,7,5,6,9,+1,-1,10,ier0)
	ier1 = max(ier1,ier0)
	ci4(6) = -cdel2*(1/fdel3)
*
*###] : kinematical matrix x4 and inverse ci4:
