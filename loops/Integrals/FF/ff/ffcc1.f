*###[ vbfffcc1:
	subroutine vbfffcc1(cc1i,cc0,cb0i,xpi,piDpj,del2,ier)
***#[*comment:***********************************************************
*									*
...
*  #[ check input:
	...
	if ( ltest ) then
		...
		if ( xpi(i) .ne. piDpj(i,i) ) then
		    print *,'vbfffcc1: error: xpi and piDpj do not agree'
		endif
    1	    continue
	    do 4 i=1,6
		do 3 j=1,6
    ...
    3		continue
    4	    continue
	    call vbfffcot3(piDpjp,xpi,dpipj,6,ier)
	    do 7 i=1,6
		do 6 j=1,6
...
*
	...
	call vbfffcc1a(cc1i,mc1i,cc0,mc0,cb0i,mb0i,xpi,piDpj,del2,ier)
*
*  #] call vbfffcc1a:
*###] vbfffxc1:
	end
*###[ vbfffcc1a:
	subroutine vbfffcc1a(cc1i,mc1i,cc0,mc0,cb0i,mb0i,xpi,piDpj,del2,
     +		ier) 
***#[*comment:***********************************************************
*									*
*	calculate the C1(mu) = C11*p1(mu) + C12*p2(mu) numerically	*
...
*
   ...
   10	continue
	...
	if ( lwarn .and. absc(cc1i(1)) .lt. xloss*xmax )
     +		call vbfffwarn(163,ier,absc(cc1i(1)),xmax)
...
*	invalidate dpipj
	dpipj(1,1) = 1
	ier1 = ier
	call vbfffcl2p(del2s2,xpi,dpipj,piDpj, 4,5,6, 1,2,3, 6,ier)
	cs(4) = + 2*cc0*del2s2
...
*
   ...
   20	continue
	if ( lwarn .and. absc(cc1i(2)) .lt. xloss*xmax )
     +		call vbfffwarn(163,ier1,absc(cc1i(2)),xmax)
