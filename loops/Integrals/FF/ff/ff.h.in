...
*
	...
	parameter(memory=12)
*
*	        if .TRUE. then                        default (vbfffinit)
...
*	nschem: scheme to handle the complex mass (see vbfffinit.f)
...
*	ner:	can be used to signal numerical problems (see vbfffrcvr)
...
*	common
*
	common /vbfffsign/isgn34,isgnal
	common /vbfffprec/ xloss,precx,precc,xalogm,xclogm,xalog2,xclog2,
     +		reqprc
	common /vbfffflag/ lwrite,ltest,l4also,ldc3c4,lmem,lwarn,ldot,
     +		nevent,ner,id,idsub,nwidth,nschem,onshel,idot
	common /vbfffcnst/ bf,xninv,xn2inv,xinfac,inx,isgn,iold,isgrot,
     +		inx5,isgn5,inx6,isgn6
	common /vbfffrota/ irota3,irota4,irota5,irota6
	common /vbfffdot/ fpij2,fpij3,fpij4,fpij5,fpij6
	common /vbfffdel/ fdel2,fdel3,fdel4s,fdel4,fdl3i,fdl4si,fdl3ij,
     +		fd4sij,fdl4i
	common /vbfffidel/ fidel3,fidel4,fidl3i,fid3ij,fidl4i
	common /vbfffcdot/ cfpij2,cfpij3,cfpij4,cfpij5,cfpij6
	common /vbfffcdel/ fodel2,fodel3,cfdl4s,fodel4,fodl3i,fod3ij,fodl4i
	common /vbfffsmug/ lsmug,lnasty,idum93,cmipj,c2sisj,ca1
