...
*	definition see vbfffxc0.vbfffdot3:comment
	s1=fpij3(4,4)
	s2=fpij3(5,5)
	s3=fpij3(4,5)
...
*###[ : kinematical matrix x4 and inverse xi4:
	if ( fdel3.eq.0 ) then
	    call vbffferr(90,ier)
	    return
	endif
*	the dotproducts are imported via ff.h
*	definition see vbfffxd0.vbfffdot4:comment
...
*
	ier0 = ier
	call vbfffdel2(del2,fpij4,10,6,7,10,1,ier0)
	ier1 = max(ier0,ier1)
	xi4(1) = +del2/fdel3
*
	...
	if ( lwarn .and. abs(del2).lt.xloss*fpij4(5,7)**2 ) then
	    ier0 = ier
	    call vbfffwarn(263,ier0,del2,fpij4(5,7)**2)
	    ier1 = max(ier0,ier1)
	endif
	xi4(2) = +del2/fdel3
*
	ier0 = ier
	call vbfffdel2(del2,fpij4,10,5,6,9,1,ier0)
	ier1 = max(ier0,ier1)
	xi4(3) = +del2/fdel3
*
	ier0 = ier
	call vbfffdl2t(del2,fpij4,5,7,6,7,10,-1,-1,10,ier0)
	ier1 = max(ier1,ier0)
	xi4(4) = -del2/fdel3
*
	ier0 = ier
	call vbfffdl2i(del2,fpij4,10,5,6,9,-1,6,7,10,+1,ier0)
	ier1 = max(ier1,ier0)
	xi4(5) = +del2/fdel3
*
	ier0 = ier
	call vbfffdl2t(del2,fpij4,5,7,5,6,9,+1,-1,10,ier0)
	ier1 = max(ier1,ier0)
	xi4(6) = -del2/fdel3
*
*###] : kinematical matrix x4 and inverse xi4:
...
*###[ : kinematical matrix x5 and inverse xi5:
	if ( fdel4.eq.0 ) then
	    call vbffferr(91,ier)
	    return
	endif
*	the dotproducts are imported via ff.h
*	definition see ffex0.vbfffdot5:comment
	s1  = fpij5(6,6)
	s2  = fpij5(7,7)
	s3  = fpij5(8,8)
	s4  = fpij5(9,9)
