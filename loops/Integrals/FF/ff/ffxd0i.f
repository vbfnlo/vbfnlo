*###[ vbfffx2ir:
	subroutine vbfffx2ir(cs1,cs2,xpip,dpipjp,ier)
***#[*comment:***********************************************************
*									*
...
*  #[ check input:
	if ( ltest ) then
     ...
     +		print *,'vbfffx2ir: wrong input: vertex (3,4,7) not all 0',
     +		xpip(3),xpip(4),xpip(7)
	    ier0 = 0
	    call vbfffxhck(xpip,dpipjp,10,ier0)
	    if ( ier0 .ne. 0 ) print *,'vbfffx2ir: error: input wrong'
	endif
*  #] check input: 
*  #[ work 3:
	if ( itest .eq. 3 ) then
	if ( lwrite ) then
	    print *,'vbfffx2ir: giving xpi(3) a mass ',delta
	endif
*
*	modify xpip,dpipjp
*
...
*
  ...
  120	continue
	idsub = idsub + 1
	ier1 = 0
	if ( lwrite ) print *,'vbfffx2ir: calling first C0'
	call vbfffxc0a(cc0,xpi3,dpipj3,ier1)
...
*
  ...
  140	continue
	idsub = idsub + 1
	ier0 = 0
	if ( lwrite ) print *,'vbfffx2ir: calling second C0'
	call vbfffxc0a(cc0,xpi3,dpipj3,ier0)
...
*  #[ work 4:
	...
	if ( lwrite ) then
	    print *,'vbfffx2ir: giving xpi(4) a mass ',delta
	endif
*
*	modify xpip,dpipjp
*
...
*  #[ error:
	...
	print *,'vbfffx2ir: error: itest should be either 3 or 4!',itest
	endif
*  #] error: 
*  #[ print:
	if ( lwrite ) then
