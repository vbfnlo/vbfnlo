...
*	error estimates.  Calls vbfffxd1, the rest is still here.		*
*	Definitions:							*
...
*					optionally u,v,w (see vbfffxd0a)	*
...
*		need 4 diff C0(I)-functions,I=1,2,3
	...
	mc0i(4)=mcxj(40)
	ier1 = ier
	call vbfffxd1a(cdxi(2),mdxi(2),cdxi(1),mdxi(1),cc0i,mc0i,
...
***		ier0 = ier
***		call vbfffwarn(283,ier0,absc(cdxi(11)),d11max)
***		ier1 = max(ier1,ier0)
***	    endif
...
***		ier0 = ier
***		call vbfffwarn(282,ier0,absc(cdxi(5)),xmax)
***		ier1 = max(ier1,ier0)
***	    endif
...
***		ier0 = ier
***		call vbfffwarn(281,ier0,absc(cdxi(6)),xmax)
***		ier1 = max(ier1,ier0)
***	    endif
...
***		ier0 = ier
***		call vbfffwarn(280,ier0,absc(cdxi(7)),xmax)
***		ier1 = max(ier1,ier0)
***	    endif
...
***		ier0 = ier
***		call vbfffwarn(279,ier0,absc(cdxi(8)),xmax)
***		ier1 = max(ier1,ier0)
***	    endif
...
***		ier0 = ier
***		call vbfffwarn(278,ier0,absc(cdxi(9)),xmax)
***		ier1 = max(ier1,ier0)
***	    endif
...
***		ier0 = ier
***		call vbfffwarn(277,ier0,absc(cdxi(10)),xmax)
***		ier1 = max(ier1,ier0)
***	    endif
*
...
*	this goes wrong in the case of complex masses - no way out yet...
	if ( awrite .and. .FALSE. ) then
	    d0 = 0
	    xmm = 0
	    if ( awrite ) print *,'calling vbfffxdi with ier = ',ier
...
*	    the A0s are not used for the moment
	    call vbfffxdi(cd4pppp,cd4ppdel,cd4deldel, cd3ppp,cd3pdel,
...
***		ier0 = ier
***		call vbfffwarn(276,ier0,absc(cdxi(22)),d22max)
***		ier1 = max(ier1,ier0)
***	    endif
...
***		ier0 = ier
***		call vbfffwarn(275,ier0,absc(cdxi(23)),d23max)
***		ier1 = max(ier1,ier0)
***	    endif
...
***		ier0 = ier
***		call vbfffwarn(274,ier0,absc(cdxi(24)),d24max)
***		ier1 = max(ier1,ier0)
***	    endif
*
...
***		ier0 = ier
***		call vbfffwarn(273,ier0,absc(cdxi(12)),xmax)
***		ier1 = max(ier1,ier0)
***	    endif
...
***		ier0 = ier
***		call vbfffwarn(272,ier0,absc(cdxi(13)),xmax)
***		ier1 = max(ier1,ier0)
***	    endif
...
***		ier0 = ier
***		call vbfffwarn(271,ier0,absc(cdxi(14)),xmax)
***		if ( awrite ) then
...
***		ier0 = ier
***		call vbfffwarn(270,ier0,absc(cdxi(15)),xmax)
***		ier1 = max(ier1,ier0)
***	    endif
...
***		ier0 = ier
***		call vbfffwarn(269,ier0,absc(cdxi(16)),xmax)
***		ier1 = max(ier1,ier0)
***	    endif
...
***		ier0 = ier
***		call vbfffwarn(268,ier0,absc(cdxi(17)),xmax)
***		ier1 = max(ier1,ier0)
***	    endif
...
***		ier0 = ier
***		call vbfffwarn(267,ier0,absc(cdxi(18)),xmax)
***		ier1 = max(ier1,ier0)
***	    endif
...
***		ier0 = ier
***		call vbfffwarn(266,ier0,absc(cdxi(19)),xmax)
***		ier1 = max(ier1,ier0)
***	    endif
...
***		ier0 = ier
***		call vbfffwarn(265,ier0,absc(cdxi(20)),xmax)
***		if ( awrite ) then
...
***		ier0 = ier
***		call vbfffwarn(264,ier0,absc(cdxi(21)),xmax)
***		ier1 = max(ier1,ier0)
***	    endif
*
