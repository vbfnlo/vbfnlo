       subroutine ten_red_LUdecomR5_M(m0,p1sq,p2sq,s12,B023,B013,B012, 
     &                     Cijr,CijI,Cij)
...
cFC      call ten_red2_forGram_M(m0,p1sq,A2,A1,B012,B12)
cFC      call ten_red2_forGram_M(m0,s12,A2,A1,B013,B13)
cFC      call ten_red2_forGram_M(m0,p2sq,A2,A1,B023,B23)

      call ten_red2_forGram_G_Num(m0,m0,musq,p1sq,A2,A1,B012,B12)
      call ten_red2_forGram_G_Num(m0,m0,musq,s12,A2,A1,B013,B13)
      call ten_red2_forGram_G_Num(m0,m0,musq,p2sq,A2,A1,B023,B23)
c      PRINT*, "HERE"
...
c 0000
       ...
       Cij(9,4)=(4*m0sq + 4*m1sq + 4*m2sq - p1sq - 
     &     p2sq - s12)/192.d0 + 
     &  (B23(2,2) + 2*m0sq*Cij(4,2) + 
     &     r10*Cij(5,3) + r21*Cij(6,3)
     &     )/8.d0
...
c 000000
       ...
       Rr(1)=(15*m0sq**2+15*m1sq**2+15*m2sq**2-3*m2sq*p1sq+p1sq**2-6*m2sq*p2sq
     &  +p1sq*p2sq+p2sq**2+3*m0sq*(5*m1sq+5*m2sq-2*p1sq-p2sq-2*s12)+3*m1
     &  sq*(5*m2sq-2*p1sq-2*p2sq-s12)-6*m2sq*s12+p1sq*s12+p2sq*s12+s12**
     &  2)/8640.d0+(B23(3,4)+2*m0sq*Cij(9,4)+(m0sq-m1sq+p1sq)*Cij(11
     &  ,5)+(m1sq-m2sq-p1sq+s12)*Cij(12,5))/12.d0
...
c 00000000
        ...
        Rr(1)=(168*m0sq**3+168*m1sq**3+168*m2sq**3-28*m2sq**2*p1sq+8*m2sq*p1sq*
     &  *2-3*p1sq**3-84*m2sq**2*p2sq+16*m2sq*p1sq*p2sq-3*p1sq**2*p2sq+24
     &  *m2sq*p2sq**2-3*p1sq*p2sq**2-3*p2sq**3+28*m0sq**2*(6*m1sq+6*m2sq
     &  -3*p1sq-p2sq-3*s12)+28*m1sq**2*(6*m2sq-3*p1sq-3*p2sq-s12)-84*m2s
     &  q**2*s12+16*m2sq*p1sq*s12-3*p1sq**2*s12+24*m2sq*p2sq*s12-4*p1sq*
     &  p2sq*s12-3*p2sq**2*s12+24*m2sq*s12**2-3*p1sq*s12**2-3*p2sq*s12**
     &  2-3*s12**3+8*m1sq*(21*m2sq**2+3*p1sq**2+3*p1sq*p2sq+3*p2sq**2+2*
     &  p1sq*s12+2*p2sq*s12+s12**2-7*m2sq*(p1sq+2*p2sq+s12))+8*m0sq*(21*
     &  m1sq**2+21*m2sq**2+3*p1sq**2+2*p1sq*p2sq+p2sq**2+7*m1sq*(3*m2sq-
     &  2*p1sq-p2sq-s12)+3*p1sq*s12+2*p2sq*s12+3*s12**2-7*m2sq*(p1sq+p2s
     &  q+2*s12)))/1.29024d6+(B23(4,6)+2*m0sq*Cij(16,6)+(m0sq-m1sq+p1
     &  sq)*Cij(19,7)+(m1sq-m2sq-p1sq+s12)*Cij(20,7))/16.d0
...
cFC       Cij(36,10)=(420*m0sq**4+420*m1sq**4+420*m2sq**4-60*m2sq**3*p1sq+15*m2sq**2*p
cFC     &  1sq**2-5*m2sq*p1sq**3+2*p1sq**4-240*m2sq**3*p2sq+45*m2sq**2*p1sq
cFC     &  *p2sq-10*m2sq*p1sq**2*p2sq+2*p1sq**3*p2sq+90*m2sq**2*p2sq**2-15*
cFC     &  m2sq*p1sq*p2sq**2+2*p1sq**2*p2sq**2-20*m2sq*p2sq**3+2*p1sq*p2sq*
cFC     &  *3+2*p2sq**4+60*m0sq**3*(7*m1sq+7*m2sq-4*p1sq-p2sq-4*s12)+60*m1s
cFC     &  q**3*(7*m2sq-4*p1sq-4*p2sq-s12)-240*m2sq**3*s12+45*m2sq**2*p1sq*
cFC     &  s12-10*m2sq*p1sq**2*s12+2*p1sq**3*s12+90*m2sq**2*p2sq*s12-20*m2s
cFC     &  q*p1sq*p2sq*s12+3*p1sq**2*p2sq*s12-20*m2sq*p2sq**2*s12+3*p1sq*p2
cFC     &  sq**2*s12+2*p2sq**3*s12+90*m2sq**2*s12**2-15*m2sq*p1sq*s12**2+2*
cFC     &  p1sq**2*s12**2-20*m2sq*p2sq*s12**2+3*p1sq*p2sq*s12**2+2*p2sq**2*
cFC     &  s12**2-20*m2sq*s12**3+2*p1sq*s12**3+2*p2sq*s12**3+2*s12**4+15*m1
cFC     &  sq**2*(28*m2sq**2+6*p1sq**2+6*p2sq**2+3*p2sq*s12+s12**2+3*p1sq*(
cFC     &  2*p2sq+s12)-4*m2sq*(3*p1sq+6*p2sq+2*s12))+15*m0sq**2*(28*m1sq**2
cFC     &  +28*m2sq**2+6*p1sq**2+3*p1sq*p2sq+p2sq**2+4*m1sq*(7*m2sq-6*p1sq-
cFC     &  2*p2sq-3*s12)+6*p1sq*s12+3*p2sq*s12+6*s12**2-4*m2sq*(3*p1sq+2*p2
cFC     &  sq+6*s12))+5*m1sq*(84*m2sq**3-4*p1sq**3-4*p1sq**2*p2sq-4*p1sq*p2
cFC     &  sq**2-4*p2sq**3-3*p1sq**2*s12-4*p1sq*p2sq*s12-3*p2sq**2*s12-2*p1
cFC     &  sq*s12**2-2*p2sq*s12**2-s12**3-12*m2sq**2*(2*p1sq+6*p2sq+3*s12)+
cFC     &  3*m2sq*(3*p1sq**2+6*p1sq*p2sq+9*p2sq**2+4*p1sq*s12+6*p2sq*s12+3*
cFC     &  s12**2))+5*m0sq*(84*m1sq**3+84*m2sq**3-4*p1sq**3-3*p1sq**2*p2sq-
cFC     &  2*p1sq*p2sq**2-p2sq**3+12*m1sq**2*(7*m2sq-6*p1sq-3*p2sq-2*s12)-4
cFC     &  *p1sq**2*s12-4*p1sq*p2sq*s12-2*p2sq**2*s12-4*p1sq*s12**2-3*p2sq*
cFC     &  s12**2-4*s12**3-12*m2sq**2*(2*p1sq+3*p2sq+6*s12)+3*m2sq*(3*p1sq*
cFC     &  *2+4*p1sq*p2sq+3*p2sq**2+6*p1sq*s12+6*p2sq*s12+9*s12**2)+3*m1sq*
cFC     &  (28*m2sq**2+9*p1sq**2+3*p2sq**2+4*p2sq*s12+3*s12**2+6*p1sq*(p2sq
cFC     &  +s12)-16*m2sq*(p1sq+p2sq+s12))))/4.8384d7+(B23(5,8)+2*m0sq*Cij
cFC     &  (25,8)+(m0sq-m1sq+p1sq)*Cij(29,9)+(m1sq-m2sq-p1sq+s12)*Cij
cFC     &  (30,9))/20.d0
cFC
cFC
...
cFC       Cij(49,12)=(3960*m0sq**5+3960*m1sq**5+3960*m2sq**5-495*m2sq**4*p1sq+110*m2sq
cFC     &  **3*p1sq**2-33*m2sq**2*p1sq**3+12*m2sq*p1sq**4-5*p1sq**5-2475*m2
cFC     &  sq**4*p2sq+440*m2sq**3*p1sq*p2sq-99*m2sq**2*p1sq**2*p2sq+24*m2sq
cFC     &  *p1sq**3*p2sq-5*p1sq**4*p2sq+1100*m2sq**3*p2sq**2-198*m2sq**2*p1
cFC     &  sq*p2sq**2+36*m2sq*p1sq**2*p2sq**2-5*p1sq**3*p2sq**2-330*m2sq**2
cFC     &  *p2sq**3+48*m2sq*p1sq*p2sq**3-5*p1sq**2*p2sq**3+60*m2sq*p2sq**4-
cFC     &  5*p1sq*p2sq**4-5*p2sq**5+495*m0sq**4*(8*m1sq+8*m2sq-5*p1sq-p2sq-
cFC     &  5*s12)+495*m1sq**4*(8*m2sq-5*p1sq-5*p2sq-s12)-2475*m2sq**4*s12+4
cFC     &  40*m2sq**3*p1sq*s12-99*m2sq**2*p1sq**2*s12+24*m2sq*p1sq**3*s12-5
cFC     &  *p1sq**4*s12+1100*m2sq**3*p2sq*s12-264*m2sq**2*p1sq*p2sq*s12+54*
cFC     &  m2sq*p1sq**2*p2sq*s12-8*p1sq**3*p2sq*s12-330*m2sq**2*p2sq**2*s12
cFC     &  +72*m2sq*p1sq*p2sq**2*s12-9*p1sq**2*p2sq**2*s12+60*m2sq*p2sq**3*
cFC     &  s12-8*p1sq*p2sq**3*s12-5*p2sq**4*s12+1100*m2sq**3*s12**2-198*m2s
cFC     &  q**2*p1sq*s12**2+36*m2sq*p1sq**2*s12**2-5*p1sq**3*s12**2-330*m2s
cFC     &  q**2*p2sq*s12**2+72*m2sq*p1sq*p2sq*s12**2-9*p1sq**2*p2sq*s12**2+
cFC     &  60*m2sq*p2sq**2*s12**2-9*p1sq*p2sq**2*s12**2-5*p2sq**3*s12**2-33
cFC     &  0*m2sq**2*s12**3+48*m2sq*p1sq*s12**3-5*p1sq**2*s12**3+60*m2sq*p2
cFC     &  sq*s12**3-8*p1sq*p2sq*s12**3-5*p2sq**2*s12**3+60*m2sq*s12**4-5*p
cFC     &  1sq*s12**4-5*p2sq*s12**4-5*s12**5+110*m1sq**3*(36*m2sq**2+10*p1s
cFC     &  q**2+10*p1sq*p2sq+10*p2sq**2+4*p1sq*s12+4*p2sq*s12+s12**2-9*m2sq
cFC     &  *(2*p1sq+4*p2sq+s12))+110*m0sq**3*(36*m1sq**2+36*m2sq**2+10*p1sq
cFC     &  **2+4*p1sq*p2sq+p2sq**2+9*m1sq*(4*m2sq-4*p1sq-p2sq-2*s12)+10*p1s
cFC     &  q*s12+4*p2sq*s12+10*s12**2-9*m2sq*(2*p1sq+p2sq+4*s12))+33*m1sq**
cFC     &  2*(120*m2sq**3-10*p1sq**3-10*p1sq**2*p2sq-10*p1sq*p2sq**2-10*p2s
cFC     &  q**3-6*p1sq**2*s12-8*p1sq*p2sq*s12-6*p2sq**2*s12-3*p1sq*s12**2-3
cFC     &  *p2sq*s12**2-s12**3-45*m2sq**2*(p1sq+3*p2sq+s12)+10*m2sq*(2*p1sq
cFC     &  **2+6*p2sq**2+3*p2sq*s12+s12**2+2*p1sq*(2*p2sq+s12)))+33*m0sq**2
cFC     &  *(120*m1sq**3+120*m2sq**3-10*p1sq**3-6*p1sq**2*p2sq-3*p1sq*p2sq*
cFC     &  *2-p2sq**3-10*p1sq**2*s12-8*p1sq*p2sq*s12-3*p2sq**2*s12-10*p1sq*
cFC     &  s12**2-6*p2sq*s12**2-10*s12**3-45*m2sq**2*(p1sq+p2sq+3*s12)+10*m
cFC     &  2sq*(2*p1sq**2+2*p1sq*p2sq+p2sq**2+4*p1sq*s12+3*p2sq*s12+6*s12**
cFC     &  2)+15*m1sq**2*(8*m2sq-3*(3*p1sq+p2sq+s12))+10*m1sq*(12*m2sq**2+6
cFC     &  *p1sq**2+3*p1sq*p2sq+p2sq**2+4*p1sq*s12+2*p2sq*s12+2*s12**2-3*m2
cFC     &  sq*(3*p1sq+2*p2sq+3*s12)))+6*m1sq*(660*m2sq**4+10*p1sq**4-165*m2
cFC     &  sq**3*(p1sq+4*p2sq+2*s12)+2*p1sq**3*(5*p2sq+4*s12)+55*m2sq**2*(p
cFC     &  1sq**2+3*p1sq*p2sq+6*p2sq**2+2*p1sq*s12+4*p2sq*s12+2*s12**2)+2*p
cFC     &  1sq**2*(5*p2sq**2+6*p2sq*s12+3*s12**2)+p1sq*(10*p2sq**3+12*p2sq*
cFC     &  *2*s12+9*p2sq*s12**2+4*s12**3)+2*(5*p2sq**4+4*p2sq**3*s12+3*p2sq
cFC     &  **2*s12**2+2*p2sq*s12**3+s12**4)-11*m2sq*(2*p1sq**3+p1sq**2*(4*p
cFC     &  2sq+3*s12)+3*p1sq*(2*p2sq**2+2*p2sq*s12+s12**2)+2*(4*p2sq**3+3*p
cFC     &  2sq**2*s12+2*p2sq*s12**2+s12**3)))+6*m0sq*(660*m1sq**4+660*m2sq*
cFC     &  *4+10*p1sq**4+8*p1sq**3*p2sq+6*p1sq**2*p2sq**2+4*p1sq*p2sq**3+2*
cFC     &  p2sq**4+165*m1sq**3*(4*m2sq-4*p1sq-2*p2sq-s12)+10*p1sq**3*s12+12
cFC     &  *p1sq**2*p2sq*s12+9*p1sq*p2sq**2*s12+4*p2sq**3*s12+10*p1sq**2*s1
cFC     &  2**2+12*p1sq*p2sq*s12**2+6*p2sq**2*s12**2+10*p1sq*s12**3+8*p2sq*
cFC     &  s12**3+10*s12**4-165*m2sq**3*(p1sq+2*p2sq+4*s12)+55*m2sq**2*(p1s
cFC     &  q**2+2*p1sq*p2sq+2*p2sq**2+3*p1sq*s12+4*p2sq*s12+6*s12**2)+55*m1
cFC     &  sq**2*(12*m2sq**2+6*p1sq**2+4*p1sq*p2sq+2*p2sq**2+3*p1sq*s12+2*p
cFC     &  2sq*s12+s12**2-3*m2sq*(3*p1sq+3*p2sq+2*s12))-11*m2sq*(2*p1sq**3+
cFC     &  p1sq**2*(3*p2sq+4*s12)+3*p1sq*(p2sq**2+2*p2sq*s12+2*s12**2)+2*(p
cFC     &  2sq**3+2*p2sq**2*s12+3*p2sq*s12**2+4*s12**3))+11*m1sq*(60*m2sq**
cFC     &  3-8*p1sq**3-6*p1sq**2*p2sq-4*p1sq*p2sq**2-2*p2sq**3-6*p1sq**2*s1
cFC     &  2-6*p1sq*p2sq*s12-3*p2sq**2*s12-4*p1sq*s12**2-3*p2sq*s12**2-2*s1
cFC     &  2**3-15*m2sq**2*(2*p1sq+3*(p2sq+s12))+5*m2sq*(3*p1sq**2+3*p2sq**
cFC     &  2+4*p2sq*s12+3*s12**2+4*p1sq*(p2sq+s12)))))/7.6640256d9+(B23(6,1
cFC     &  0)+2*m0sq*Cij(36,10)+(m0sq-m1sq+p1sq)*Cij(41,11)+(m1sq-m2s
cFC     &  q-p1sq+s12)*Cij(42,11))/24.d0
cFC
cFC
cFC
cFC
