       subroutine tens_red4_new_Re_Com(p1sq,p2sq,p3sq,p1p2,p1p3,p2p3, 
...
c
       ...
       complex*16 D0
       real*8 r1, r2r1, r3r2, det,Iv,Ivv
       ...
       real*8 D0r, Dijr(13,3), Dijr1(13,3)
       real*8 D0I, DijI(13,3),DijI1(13,3)
...
c$$$CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
c$$$CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
c$$$C### START Gram Determinant
c$$$CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
c$$$CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
c$$$CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
c$$$
c$$$       cdet =2.d0*(abs(-2.d0*p1p2*p1p3*p2p3) +abs( p1p3*p1p3*p2sq) 
c$$$     -  +abs(p1p2*p1p2*p3sq)+abs(p1sq*p2p3*p2p3)+abs(p1sq*p2sq*p3sq))
c$$$
c$$$      If(abs(det/cdet).lt.para) then
c$$$c d-4
c$$$c         GOTO 200
c$$$
c$$$c$$$      print*, "RATIO_D", abs(det/cdet)
c$$$c$$$       print*, "det", 4d0*det
c$$$c$$$       print*, "abs", 4d0*cdet
c$$$!       Print*, "D Active"
c$$$       call MyDgetGram(p1sq,p2sq,p3sq,p1p2,p1p3,p2p3,musq,D0R,D0I,Dij)
c$$$       IF(TEMPKL.Ge.2.4D-3) THEN
c$$$       Print*, "Dkl200"
c$$$          GOTO 200
c$$$       ENdif
...
c$$$       ENDIF
c$$$
c$$$       Dijr(1,1) = Dble(Dij(1,1))
c$$$       Dijr(2,1) = Dble(Dij(2,1))
c$$$       Dijr(3,1) = Dble(Dij(3,1))
c$$$          
c$$$       Dijr(7,1)  = Dble(Dij(16,4))
c$$$       Dijr(8,1)  = Dble(Dij(17,4))
c$$$       Dijr(9,1)  = Dble(Dij(18,4))
c$$$       Dijr(10,1) = Dble(Dij(19,4))
c$$$       Dijr(11,1) = Dble(Dij(20,4))
c$$$       Dijr(12,1) = Dble(Dij(21,4))
c$$$       Dijr(13,1) = Dble(Dij(22,4))
c$$$          
c$$$       Dijr(1,2) = Dble(Dij(1,2))
c$$$       Dijr(2,2) = Dble(Dij(2,2))
c$$$       Dijr(3,2) = Dble(Dij(3,2))
c$$$       Dijr(4,2) = Dble(Dij(4,2))
c$$$       Dijr(5,2) = Dble(Dij(5,2))
c$$$       Dijr(6,2) = Dble(Dij(6,2))
c$$$       Dijr(7,2) = Dble(Dij(7,2))
c$$$         
c$$$       Dijr(1,3) = Dble(Dij(1,3))
c$$$       Dijr(2,3) = Dble(Dij(2,3))
c$$$       Dijr(3,3) = Dble(Dij(3,3))
c$$$       Dijr(4,3) = Dble(Dij(4,3))
c$$$       Dijr(5,3) = Dble(Dij(5,3))
c$$$       Dijr(6,3) = Dble(Dij(6,3))
c$$$       Dijr(7,3) = Dble(Dij(7,3))
c$$$       Dijr(8,3) = Dble(Dij(8,3))
c$$$       Dijr(9,3) = Dble(Dij(9,3))
c$$$       Dijr(10,3) = Dble(Dij(10,3))
c$$$       Dijr(11,3) = Dble(Dij(11,3))
c$$$       Dijr(12,3) = Dble(Dij(12,3))
c$$$       Dijr(13,3) = Dble(Dij(13,3))
c$$$cccccccccccccccccccccccccccccccccccccccccccc
c$$$       DijI(1,1) = DImag(Dij(1,1))
c$$$       DijI(2,1) = DImag(Dij(2,1))
c$$$       DijI(3,1) = DImag(Dij(3,1))
c$$$          
c$$$       DijI(7,1)  = DImag(Dij(16,4))
c$$$       DijI(8,1)  = DImag(Dij(17,4))
c$$$       DijI(9,1)  = DImag(Dij(18,4))
c$$$       DijI(10,1) = DImag(Dij(19,4))
c$$$       DijI(11,1) = DImag(Dij(20,4))
c$$$       DijI(12,1) = DImag(Dij(21,4))
c$$$       DijI(13,1) = DImag(Dij(22,4))
c$$$         
c$$$       DijI(1,2) = DImag(Dij(1,2))
c$$$       DijI(2,2) = DImag(Dij(2,2))
c$$$       DijI(3,2) = DImag(Dij(3,2))
c$$$       DijI(4,2) = DImag(Dij(4,2))
c$$$       DijI(5,2) = DImag(Dij(5,2))
c$$$       DijI(6,2) = DImag(Dij(6,2))
c$$$       DijI(7,2) = DImag(Dij(7,2))
c$$$      
c$$$       DijI(1,3) = DImag(Dij(1,3))
c$$$       DijI(2,3) = DImag(Dij(2,3))
c$$$       DijI(3,3) = DImag(Dij(3,3))
c$$$       DijI(4,3) = DImag(Dij(4,3))
c$$$       DijI(5,3) = DImag(Dij(5,3))
c$$$       DijI(6,3) = DImag(Dij(6,3))
c$$$       DijI(7,3) = DImag(Dij(7,3))
c$$$       DijI(8,3) = DImag(Dij(8,3))
c$$$       DijI(9,3) = DImag(Dij(9,3))
c$$$       DijI(10,3) = DImag(Dij(10,3))
c$$$       DijI(11,3) = DImag(Dij(11,3))
c$$$       DijI(12,3) = DImag(Dij(12,3))
c$$$       DijI(13,3) = DImag(Dij(13,3))
c$$$
c$$$c$$$       write(*,'(A5,E25.17)') "p1sq=",p1sq
c$$$c$$$       write(*,'(A5,E25.17)') "p2sq=",p2sq
c$$$c$$$       write(*,'(A5,E25.17)') "p3sq=",p3sq
c$$$c$$$       write(*,'(A5,E25.17)') "p1p2=",p1p2
c$$$c$$$       write(*,'(A5,E25.17)') "p1p3=",p1p3
c$$$c$$$       write(*,'(A5,E25.17)') "p2p3=",p2p3
c$$$c$$$       write(*,'(A5,E25.17)') "musq=",musq
c$$$c$$$       Print*,' D0',D0
c$$$c$$$       Print*,' D0r',D0r
c$$$c$$$       Print*,' D0i',D0i
c$$$c$$$
...
c$$$       endif
c$$$  
c$$$c$$$c$$$CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
c$$$c$$$c$$$CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
c$$$c$$$c$$$CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
c$$$c$$$c$$$C### Finish Gram Determinant
c$$$c$$$c$$$CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
c$$$c$$$c$$$CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
c$$$c$$$CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
...
c      
       PRr(1) = (Cijr_134(1,1) + C0r_234 - Dijr(1,1)*r1 - Dijr(7,2)*2.d0)
...
c       
       ...
       Dijr(5,2) = Rr(3)
c       
       PRI(1) = (CijI_134(1,1) + C0I_234  - DijI(1,1)*r1 - DijI(7,2)*2.d0)
...
c 33-3 4-35
       PRr(1) = (Cijr_134(1,1) -Cijr_234(1,1) - Dijr(2,1)*r1          )
...
c       Dijr(4,2) = Rr(1)
       ...
       PRI(1) = (CijI_134(1,1) -CijI_234(1,1) - DijI(2,1)*r1          )
...
c 36-3 7-38
       ...
       PRr(1) = (Cijr_134(2,1) - Cijr_234(2,1) - Dijr(3,1)*r1      )
...
c       Dijr(6,2) = Rr(2)
       ...
       PRI(1) = (CijI_134(2,1) - CijI_234(2,1) - DijI(3,1)*r1      )
...
c 41-4 2-43
       ...
       PRr(1) =(Cijr_134(1,2) - C0r_234 - Dijr(1,2)*r1  - Dijr(11,3)*4.d0)
       ...
       PRI(1) =(CijI_134(1,2) - C0I_234 - DijI(1,2)*r1  - DijI(11,3)*4.d0)
...
c 50-5 1-52
       ...
       PRr(1) =  (Cijr_134(1,2) - Cijr_234(1,2) - Dijr(2,2)*r1)
     ...
     &       -Dijr(12,3)*4.d0)
       ...
       PRI(1) =  (CijI_134(1,2) - CijI_234(1,2) - DijI(2,2)*r1)
...
c      
c      
       PRr(1) = (Cijr_134(2,2) - Cijr_234(2,2) - Dijr(3,2)*r1)
...
c       
       ...
       Dijr(3,3) = Rr(3)
c      
       PRI(1) = (CijI_134(2,2) - CijI_234(2,2) - DijI(3,2)*r1)
...
c      
       ...
       DijI(3,3) = RI(3)
c 44-4 5-46
       PRr(1) = (Cijr_134(1,2) + Cijr_234(1,1) - Dijr(4,2)*r1 
     &      -Dijr(12,3)*2.d0)
...
c      
c      
       PRI(1) = (CijI_134(1,2) + CijI_234(1,1) - DijI(4,2)*r1 
     &      -DijI(12,3)*2.d0)
